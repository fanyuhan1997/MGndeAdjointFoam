...
) const
{
    //Fluxnbr         phi2;
    //FluxName	phi2;
    //nbrDiffFieldName Dg2;
	//myDiffFieldName  Dg2; 
	//myAlpha			uniform 0;
	//nbrAlpha		uniform 0;
    mixedFvPatchScalarField::write(os);
    writeEntry(os, "Fluxnbr", FluxnbrName_);
    //writeEntry(os, "FluxName", FluxnbrName_);
    //writeEntry(os, "nbrDiffFieldName", nbrDFieldName_);
    //writeEntry(os, "myDiffFieldName", myDFieldName_);
    //writeEntry(os, "myAlpha	", myAlpha_);
    //writeEntry(os, "myAlpha	", nbrAlpha_);
